...
const studies = [
  {
    ...
    citations: [
      'Conscientiousness, emphasizing self-discipline, responsibility, and integrity, has been linked to ethical leadership behaviors. Leaders high in conscientiousness tend to demonstrate greater adherence to ethical principles and promote ethical conduct within the organization. Brown, M. E., & Treviño, L. K. (2006). The Leadership Quarterly, 17(6).',
    ],
  },
  {
  ...
  },
  {
    trait: 'Humility',
    citations: [
      'Honesty-humility from the HEXACO model is particularly relevant for predicting counterproductive work behaviors and integrity-related outcomes. Honesty-humility was negatively associated with workplace deviance. Ashton, M. C., & Lee, K. (2007). Personality and Social Psychology Review, 11(2).',
    ],
  },
  {
    trait: 'Big Five: Agreeableness',
    citations: [
      'Individuals who scored low on agreeableness were more likely to engage in unethical behavior or display counterproductive work behaviors. Hogan, R., & Hogan, J. (1993). Hogan Personality Inventory Manual.',
    ],
  },
  {
    trait: 'Dark Triad: Low Psychopathy, Low Narcissism, Low Machiavellianism',
    citations: [
      'Narcissism motivates individuals to act unethically for personal benefit. Machiavellianism motivates unethical behavior and alters perceptions about opportunities to deceive. Psychopathy has a prominent effect on how individuals rationalize fraudulent behaviors. The Dark Triad elements act in concert as powerful psychological antecedents to fraud behaviors. Andrew J. Harrison et al. Journal of Business Ethics, 153 (2018).',
    ],
  },
]
...
export default function LeadershipEthicsPage() {
  return (
    <>
      <NavPill />
      <main>
        <section style={{ paddingTop: 'calc(5rem + 80px)', paddingBottom: 'var(--space-3xl)', background: 'var(--bg-ground)', overflow: 'hidden', position: 'relative' }}>
          ...
          <div className="container" style={{ maxWidth: 820 }}>
            <motion.div initial={{ opacity: 0, y: 36 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <h1 className="display-xl">Leadership Ethics</h1>
              <p className="body-lg" style={{ maxWidth: 600 }}>How strong are your ethics and how likely are you to foment organizational conflict?</p>
              <div style={{ marginTop: '1rem', background: 'rgba(255,255,255,0.7)', border: '1px solid var(--border-hairline)', borderRadius: 'var(--radius-xl)', padding: '6px', maxWidth: 720 }}>
                <div style={{ background: 'var(--bg-surface)', borderRadius: 'calc(var(--radius-xl) - 6px)', padding: '1.75rem 2rem', boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.9)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  ...
                  <p className="body-md" style={{ color: 'var(--text-body)', lineHeight: 1.7 }}>This score assesses a leader's overall level of ethics and integrity, particularly the likelihood of fomenting serious interorganizational conflict. The Dark Triad — narcissism, Machiavellianism, and psychopathy — are among the best predictors of internal ethics issues, conflict, and incidents, and are weighted more heavily in this model.</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <section className="section" style={{ background: 'var(--bg-surface)' }}>
          <div className="container" style={{ maxWidth: 640 }}>
            <motion.div {...fadeUp} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              ...
              <div style={{ textAlign: 'center', paddingTop: '0.5rem' }}><CTAButton href="/logos-auto-report-checkoutz2hb1fcn" size="lg" id="ethics-cta">Begin Your Logos — $38</CTAButton></div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="section" style={{ background: 'var(--bg-surface)', textAlign: 'center' }}>
          <div className="container" style={{ maxWidth: 520 }}><motion.div {...fadeUp} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.75rem' }}><h2 className="display-md">Are you ready to experience clarity?</h2><CTAButton href="/logos-auto-report-checkoutz2hb1fcn" size="lg" id="ethics-bottom-cta">Begin Your Logos</CTAButton></motion.div></div>
        </section>
      </main>
